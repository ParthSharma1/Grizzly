...
<springform:form modelAttribute="updateMedicine" name="RegForm"  method="post" action="updatemedicinedata.htm" >
<table cellspacing="20">

<tr>
<td class="fonts  breaking"><springform:label path="medicineId">Medicine Id:</springform:label>
<td class="fonts  breaking"><springform:input path="medicineId" readonly="true"/>
...
<tr>
<td class="fonts breaking"><springform:label    path="cureFor">Cure For:</springform:label>
...
<td class="fonts breaking"  ><springform:input  id="prescribed_for" path="prescribedFor" maxlength="1" name="pf" onkeypress=" return alphaSpecific(event)" />
...
<td  class="fonts"  ><springform:input id="dosage" class="textcol" path="dosage" type="text" name="dos" maxlength="3" onkeypress=" return numberOnly(event)"/></td>
</tr>


<tr>
<td class="fonts" ><springform:label   path="quantity">Quantity:</springform:label>
<td class="fonts"><springform:input  id="quantity" class="textcol" path="quantity" type="text" name="qty" maxlength="3" onkeypress=" return numberOnly(event)"  /></td>
</tr>
...
<td><input class="listh" type="submit"  value="update" onclick="return validit(event)" ></td>
</table>
  </div>
