...
<script type="text/javascript">
	function fn(event) {
		...
		var st = document.getElementById("sts").value;
		var ct = document.getElementById("cities").value;
		...
		else if(st==null||st==""||st=="Select State")
			{
			 alert("Please select state");
			 return false;
			}
		else if (ct==null||ct==""||ct=="Select City")
			{
		...
		<springform:form modelAttribute="branchadmin" method="post"
			...
			<table>
				...
				<tr>
					...
					<td><springform:select id="gender" path="branchAdminGender"
							style="height : 30px;">
				...
				<tr>
					...
					<td><springform:input path="zipCode" placeholder="Zip Code"
							id="zip_code" style="height : 30px;" minlength="6" maxlength="6"
