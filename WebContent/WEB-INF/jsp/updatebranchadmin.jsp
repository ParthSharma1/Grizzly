...
<script type="text/javascript">
  ...
  var k=0;
	function print_state(state_id){
		...
		option_str.length=0;
		option_str.options[0] = new Option("${branchAdminUpdate.state}",'${branchAdminUpdate.state}');
	...
	function print_city(city_id, city_index){
		if(k==0)
			...
			option_str.options[0] = new Option('${branchAdminUpdate.city}','${branchAdminUpdate.city}');
			}
		else
			{
		var option_str = document.getElementById(city_id);
...
<body onload="print_city('cities', this.selectedIndex);">
	...
	<div class="dropdown" id="right">
		...
		<div class="dropdown-content">
			<a href="showmedicinerequests.htm">Branch Admin Requests </a> <a
				href="showcreaterequestpage.htm">Create Request</a>
	...
	<div id="right" class="dropdown ">
		...
		<div class="dropdown-content">
			<a href="showbranchadminpage.htm">Available BA</a> <a
				href="createbranchadmin.htm">Create New</a>
		</div>
	</div>

	<div class="form">
		<springform:form modelAttribute="branchAdminUpdate" method="post"
			action="updatebranchadmin.htm">
			<table>
				<tr>
					<td><springform:label path="branchAdminId">Branch Admin ID:</springform:label>
					<td><springform:input path="branchAdminId" readonly="true"
							style="height : 30px;" id="first_name" autocomplete="off"
							maxlength="50" />
				</tr>
				<tr>
				...
				<tr>
				<td><springform:label path="branchAdminDOB">DateofBirth:</springform:label>
					<td><springform:input path="branchAdminDOB" id="dob"
							type="date" style="height : 30px;" autocomplete="off"
				...
				<td><springform:label path="branchAdminAge">Age:</springform:label>
					<td><springform:input path="branchAdminAge" placeholder="Age"
							maxlength="2" id="agecal" style="height : 30px;" autocomplete="off"
							onclick="return agecalculator(this);" readonly="true"  />
				...
				<tr>
					...
					<td><springform:select path="state" onchange="print_city('cities', this.selectedIndex);" id="sts" name ="stt"  value="" class="form-control"  style="height : 30px;"
											  />
	 				<script language="javascript">print_state("sts");</script>
				</tr>
				<tr>
					<td><springform:label path="city">City:</springform:label>
					<td><springform:select path="city" id="cities" class="form-control" 
							style="height : 30px;"/>
					<td></td>
					<td></td>
					<td></td>
					...
					<td><springform:input path="zipCode" placeholder="Zip Code"
							id="zip_code" style="height : 30px;" maxlength="6" minlength="6"
							autocomplete="off" onkeypress="return isNumber(event)" />
				</tr>
				<div class="Update">
					<input type="submit" value="Update" onclick="return fn(event);" />
				</div>
			</table>
		</springform:form>
	</div>
